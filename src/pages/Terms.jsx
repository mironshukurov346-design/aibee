...
export default function Terms({ pageTitle = 'Contact Us' }) {
  const [isOpen, setIsOpen] = useState(false)

  // Matnlarni osongina o'zgartirish yoki ko'paytirish uchun massiv (array)
  const contentItems = [
    {
  ...
  return (
    <div>
      ...
      {/* YANGI QO'SHILGAN MATNLAR QISMI */}
